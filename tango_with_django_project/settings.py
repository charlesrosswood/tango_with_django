...
# The path to the static files for the rango app
STATIC_PATH = os.path.join(PROJECT_PATH, 'static')

# RANGO_STATIC_PATH = os.path.join(STATIC_PATH, 'rango')
# RANGO_IMAGES_PATH = os.path.join(RANGO_STATIC_PATH, 'images')
# RANGO_CSS_PATH = os.path.join(RANGO_STATIC_PATH, 'css')
# RANGO_JS_PATH = os.path.join(RANGO_STATIC_PATH, 'js')
...
SECRET_KEY = 'jlhc-b)24a$_j!!%@oh0fx%-p4xt)6m$cd5wmivoyte4*7b9i9'
